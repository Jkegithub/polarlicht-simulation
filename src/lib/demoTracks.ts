...
export const DEMO_TRACKS: DemoTrack[] = [
  ...
  {
    id: "grieg",
    label: "Grieg – „Morgenstimmung“ (Peer Gynt)",
    genre: "Romantik",
    kind: "file",
    url: "audio/grieg-morgenstimmung.ogg",
    credit: "Aufnahme: Musopen Kickstarter Project (gemeinfrei) · archive.org/details/MusopenCollectionAsFlac",
  },
  {
    id: "smetana",
    label: "Smetana – „Die Moldau“",
    genre: "Romantik",
    kind: "file",
    url: "audio/smetana-moldau.ogg",
    credit: "Aufnahme: Musopen Kickstarter Project (gemeinfrei) · archive.org/details/MusopenCollectionAsFlac",
  },
  {
    id: "mendelssohn",
    label: "Mendelssohn – „Die Hebriden“ (Fingalshöhle)",
    genre: "Romantik",
    kind: "file",
    url: "audio/mendelssohn-hebriden.ogg",
    credit: "Aufnahme: Musopen Kickstarter Project (gemeinfrei) · archive.org/details/MusopenCollectionAsFlac",
  },
  {
    id: "borodin",
